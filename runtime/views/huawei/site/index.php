            ...
            <div id="main" class="container">
                ...
                <div class="collapse navbar-collapse" id="top-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right text-center">
                        <li>
                            <a i18n="i18n.togglelang"  href="https://www.ajvs.com/new/create_account.php">中英文切换</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="row top_menu_items">
            <div class="row margin-15">
                <div class="col-item col-sm-4 block_display logo-block">
                    <a href="/">
                        <img class="logo" src="static/img/ishop-logo.png" />
                    </a>
                ...
                <div class="row margin-15">
                    ...
                    <div class="col-xs-12 col-sm-4 clearfix repair-btns">
                        <div class="btn-wrap">
                            ...
                            <a id="rma" type="button" href="http://106.54.154.210:8080/rma_static.html" target="_blank" class="btn btn-default bgcolor-main color-white">
                                <span class="
                                        glyphicon glyphicon-list-alt"></span>
                                RMA</a>
                        </div>
                        <div class="btn-wrap">
                            <a  href="http://106.54.154.210:8080/repair_cost.html" id="repair" type="button" class="btn btn-default bgcolor-main color-white">
                    ...
                    <div class="swiper-slide">
                        <div class="row">
                            <div class="col-item col-sm-3">
                                ...
                                <a href="http://106.54.154.210:8080/category_static.html"></a>
                            </div>
                            <div class="col-item col-sm-3">
                                ...
                                <a href="/pages/category_static.html"></a>
                            </div>
                            <div class="col-item col-sm-3">
                        ...
                        <div class="row">
                            <div class="col-item col-sm-4">
                                ...
                                <div class="item-item-content">
                                    ...
                                    <div class="btns-wrap">
                                        <a href="http://106.54.154.210:8080/item_detail.html"  target="_blank">详情</a>
                                        <a class="btn btn-danger btn-sm" href="http://106.54.154.210:8080/item_detail.html"  target="_blank">购买</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-item col-sm-4">
                                ...
                                <div class="item-item-content">
                                    ...
                                    <div class="btns-wrap">
                                        <a href="/pages/item_detail.html"  target="_blank">详情</a>
...
<script>
    //当首页时显示分类
    <?php if( IWeb::$app->getController()->getId() == 'site' && IWeb::$app-> getController()-> getAction()-> getId() == 'index'){?>$('.catlist').removeClass('none');$('.itemlist').removeClass('none'); <?php }?>
        $(function() {
...
<script>
        $("[i18n]").i18n({
            defaultLang: "en",
            filePath: "/eshop/views/huawei/i18n/", //注意！要配置好语言文件的正确路径
            filePrefix: "i18n_",
            fileSuffix: "",
            forever: true,
