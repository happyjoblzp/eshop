...
class checkConfig
{
	...
	private $recom_extension = array('zip','curl','OpenSSL','mbstring','sockets');
	private $writeable_dir   = array('config/config.php','config/site_config.php','config/plugin_config.php','install','backup','index.php','upload','runtime');
