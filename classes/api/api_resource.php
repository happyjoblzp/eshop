...
return array(
    ...
    'getOrderRecycleList' => array(
        'query'=>array(
            ...
            'fields'  => 'o.id as oid,d.name as dname,p.name as pname,o.order_no,o.accept_name,o.pay_status,o.pay_type,o.distribution_status,u.username,o.create_time,o.status,o.type',
            'where'   => 'if_del = 1',
            'page'    => IReq::get('page') ? IReq::get('page') : 1,
        )
    ),
    ...
    'getListByProp'=>array(
        'query'=>array(
            'name'  => 'prop',
            'where' => 'type = 0 and `condition` = #ticket_id# and seller_id = '.(isset(IWeb::$app->getController()->seller['seller_id']) ? IWeb::$app->getController()->seller['seller_id'] : 0),
            'page'  => IReq::get('page') ? IReq::get('page') : 1,
        )
    ),
